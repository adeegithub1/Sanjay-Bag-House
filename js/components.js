/* ============================================================
   SANJAY BAG HOUSE — SHARED UI COMPONENTS v2
   Marketplace-style header: always-visible mobile search bar,
   category icon rail, navy header.
   ============================================================ */
...
(function () {
  ...
  const CATEGORY_LINKS = [
    { label: "Backpacks", slug: "backpacks", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=100&h=100&fit=crop&q=80" },
    { label: "School Bags", slug: "school-bags", img: "https://images.unsplash.com/photo-1577733966973-d680bffd2e80?w=100&h=100&fit=crop&q=80" },
    { label: "Laptop Bags", slug: "laptop-bags", img: "https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=100&h=100&fit=crop&q=80" },
    { label: "Travel Bags", slug: "travel-bags", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=100&h=100&fit=crop&q=80" },
    { label: "Trolley Bags", slug: "trolley-bags", img: "https://images.unsplash.com/photo-1565026057447-bc90a3dceb87?w=100&h=100&fit=crop&q=80" },
    { label: "Ladies Bags", slug: "ladies-bags", img: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=100&h=100&fit=crop&q=80" },
  ];
    ...
    <header class="site-header">
      <div class="container header-inner">
        ...
        <div class="header-actions">
          <button class="icon-btn" aria-label="Search" onclick="SBHComponents.openSearch()" style="display:none;" id="desktopSearchBtn">
      ...
      <div class="mobile-search-row">
        <div class="search-input-row" onclick="SBHComponents.openSearch()" style="cursor:pointer;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#6B7280" stroke-width="1.8"><circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/></svg>
          <input type="text" placeholder="Search for backpacks, trolley bags..." readonly style="cursor:pointer;" />
        </div>
      </div>
      <div class="cat-rail">
        ${CATEGORY_LINKS.map(c => `
          <a class="cat-rail-item" href="/category.html?slug=${c.slug}">
    ...
    <div class="search-overlay" id="searchOverlay">
      <div class="search-panel">
        <div class="search-input-row">
          ...
          <button class="icon-btn" aria-label="Close search" style="color:var(--color-text);" onclick="SBHComponents.closeSearch()">
